...
while True:
    ...
    if operation == '1':
        ...
        subprocess.run(["python3", "add_update_countries.py"])
        print('Done\n')

        # Run add_ip_perfix.py
        print('Adding the ip perfixes to database.')
        subprocess.run(["python3", "add_ip_perfix.py"])
        print('Done\n')
    elif operation == '2':
        # Run add_update_countries.py
        ...
        subprocess.run(["python3", "add_update_ip_country.py"])
        print('Done\n')
    elif operation == '4':
        # Run finding_countries.py
        while True:
            subprocess.run(["python3", "finding_countries.py"])
